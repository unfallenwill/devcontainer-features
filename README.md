...
```jsonc
{
    ...
    "features": {
        "ghcr.io/<owner>/feature-starter/mimo-code:1": {}
    }
}
```
...
The provided GitHub Action will also publish a "metadata" package with just the namespace, eg: `ghcr.io/<owner>/feature-starter`. This contains information useful for tools aiding in Feature discovery.
...
```
https://github.com/users/<owner>/packages/container/<repo>%2F<mimo-code>/settings
```
